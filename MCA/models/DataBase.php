...
class DataBase {
    ...
    public static function createConccection($dataBaseVars)
    {
        if (!isset(self::$instance)) {
            self::$instance = new DataBase($dataBaseVars);
        }
        return self::$instance;
    }
   
    private function DataBase($dataBaseVars)
    {
