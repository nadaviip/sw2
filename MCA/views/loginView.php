        ...
        <section id="login">
           ...
           <span class="error"><?php echo $message?></span>
            <form id="loginForm" name="loginForm" method="post" action="../controllers/login_c.php" autocomplete="on">
                <input class = "input-lg" id="email" name="email" type="text" placeholder="Enter your user name here !" onfocus="this.placeholder=''" onblur="this.placeholder='Enter your user name here !'">
